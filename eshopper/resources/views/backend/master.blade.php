...
<body>
    ...
    <div class="container-fluid Main">
        <div class="row">
                    ...
                    <ul class="m-0 p-0" id="side-menu">
                        ...
                        <li class="list-unstyled py-1">
                            <a class="text-decoration-none text-dark font-weight-bold d-flex align-items-center py-2 px-3 Main_row_col-3_CateNav_a"
                                ...
                                <p class="m-0 Main_row_col-3_CateNav_a_p">CATEGORY</p>
                            </a>
                        </li>
                        <li class="list-unstyled py-1">
                            <a class="text-decoration-none text-dark font-weight-bold d-flex align-items-center py-2 px-3 Main_row_col-3_CateNav_a"
            ...
            <div class="col-9 bg-best p-0">
                <div class="col-12 py-2 bg-dark-blue d-flex justify-content-between align-items-center">
                    <div class="col-4 py-3">
                        <div class="input-group">
                            <input type="text" class="form-control" placeholder="SEARCH ..."
                                aria-label="Recipient's username" aria-describedby="button-addon2">
                            <div class="input-group-append">
                                <button class="btn btn-best" type="button" id="button-addon2">
                    ...
                    <div class="col-6 text-right">
                        <div class="dropdown">
                            <a class="text-white text-decoration-none py-2 px-4 bg-hover text-dark rounded cursor"
